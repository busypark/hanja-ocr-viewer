document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("btnTextEraseL").addEventListener("click", () => {
    searchText.value = searchText.value.slice(1);
  });
  document.getElementById("btnTextEraseR").addEventListener("click", () => {
